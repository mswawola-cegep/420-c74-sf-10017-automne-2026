...
def plot_results(X, y, XX, YY, F, sF, axes):
    ...
    axes[0].contour(XX,YY,F,[0], colors=["g"])
    axes[0].set_xlabel(r"$x_1$")
    axes[0].set_ylabel(r"$x_2$")

    # ContourSet.collections n'existe plus depuis matplotlib 3.10 => entrée de légende ajoutée manuellement
    axes[0].plot([], [], color="g", label='Frontière de décision')
